...
const styles = StyleSheet.create({
    ...
    profileCard: { borderRadius: normalize(20), padding: normalize(24), alignItems: 'center',     },
    ...
    performanceCard: { borderRadius: normalize(16), padding: normalize(20), marginBottom: verticalScale(24),     },
    ...
    settingsContainer: { borderRadius: normalize(16), paddingHorizontal: normalize(16), marginBottom: verticalScale(24),     },
