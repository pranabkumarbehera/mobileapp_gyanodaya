...
export const themes: Record<string, ThemeColors> = {
    ...
    glass: {
        ...
        Black: '#F8FAFF',
        Background: '#080D1D',
        cardBackground: 'rgba(24, 33, 63, 0.72)',
        text: '#F8FAFF',
        textSecondary: '#A9B5D1',
        border: 'rgba(201, 214, 255, 0.16)',
        accent: '#8B9CFF',
        statusBar: 'light-content',
        statusBg: '#080D1D',
        tabBg: 'rgba(16, 23, 47, 0.9)',
        tabActive: '#8B9CFF',
        tabInactive: '#7582A4',
        tagCyan: 'rgba(53, 216, 255, 0.14)',
        tagCyanText: '#6BE5FF',
        tagGreen: 'rgba(52, 211, 153, 0.14)',
        tagGreenText: '#6EE7B7',
        tagOrange: 'rgba(251, 191, 36, 0.14)',
        tagOrangeText: '#FCD34D',
        tagPurple: 'rgba(167, 139, 250, 0.16)',
